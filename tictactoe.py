...
Entry(tk,borderwidth=5,textvar=p1,font=("Courier New",16,'bold')).grid(row=1, column=1, columnspan=8)
Entry(tk,borderwidth=5,textvar=p2,font=("Courier New",16,'bold')).grid(row=2, column=1, columnspan=8)
